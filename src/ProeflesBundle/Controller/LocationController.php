...
class LocationController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('ProeflesBundle\Form\LocationsType', $location);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('locations_show', array('id' => $location->getId()));
        }
    ...
    {
        $deleteForm = $this->createDeleteForm($location);
        $editForm = $this->createForm('ProeflesBundle\Form\LocationsType', $location);
